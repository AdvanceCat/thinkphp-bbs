            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li><a href="/index.php?m=account&amp;a=settings">基本信息</a></li>
                        <li class="active"><a href="/index.php?m=account&amp;a=avatar">修改头像</a></li>
                        <li><a href="/index.php?m=account&amp;a=password">密码安全</a></li>
                    </ul>
                    <div class="talk-account">
                        <div class="col-md-2">
                            <img id="user-avatar" src="http://bbs.wemallshop.com/Public/upload/avatar/000/00/13/33_avatar_big.jpg" alt="" class="talk-avatar big">
                        </div>
                        <div class="col-md-4">
                                <span class="btn btn-success fileinput-button">
                                    <span>上传头像...</span>
                                    <input id="fileupload" type="file" name="files" data-url="/index.php?m=account&amp;a=upload">
                                </span>
                        </div>
                    </div>
                </div>
