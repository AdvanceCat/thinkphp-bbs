            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li><a href="<?php echo U('Home/User/setting');?>">基本信息</a></li>
                        <li class="active"><a href="<?php echo U('Home/User/avatar');?>">修改头像</a></li>
                        <li><a href="<?php echo U('Home/User/password');?>">密码安全</a></li>
                    </ul>
