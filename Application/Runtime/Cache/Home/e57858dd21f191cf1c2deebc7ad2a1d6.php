                ...
                <div class="account-setting">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="<?php echo U('Home/User/password');?>">密码安全</a></li>
                        </ul>
                        <div class="talk-account">
                            <form id="password" class="form-horizontal" action="/index.php?m=account&amp;a=password" method="post" novalidate="novalidate">
                                <fieldset>
