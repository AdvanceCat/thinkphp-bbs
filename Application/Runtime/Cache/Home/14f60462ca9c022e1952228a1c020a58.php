            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="<?php echo U('Home/User/setting');?>">基本信息</a></li>
                        <li><a href="<?php echo U('Home/User/avatar');?>">修改头像</a></li>
                        <li><a href="<?php echo U('Home/User/password');?>">密码安全</a></li>
                    </ul>
                    <div class="talk-account">
                        <form class="form-horizontal" action="/index.php?m=account&amp;a=settings" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="radio" name="gender" id="sex" value="2">女
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="intro" rows="6" cols="5"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
